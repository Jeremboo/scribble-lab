...
import {
  Color, Vector2, LinearFilter, MeshBasicMaterial,
  DoubleSide, WebGLRenderTarget, MeshDepthMaterial, RGBADepthPacking,
  NoBlending, OrthographicCamera, Scene, UniformsUtils,
  Mesh, PlaneBufferGeometry, Matrix4, ShaderMaterial, AdditiveBlending,
  RGBAFormat, Vector3,
} from 'three';
