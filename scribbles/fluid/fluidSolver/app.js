...
import 'fluidSolver.js';

/**
 * EXEMPLES:
 * - BASED ON : https://github.com/topaz1008/canvas-fluid-solver
 + _ http://jamie-wong.com/2016/08/05/webgl-fluid-simulation/
 */

const NUM_OF_CELLS = 128; // Number of cells (not including the boundary)
const VIEW_SIZE = 640 * 2;    // View size (square)
...
class Particle {
  constructor(x, y) {
    this.TIME_TO_LIVE = 5;  // Time to live in seconds
